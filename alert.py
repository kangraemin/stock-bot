...
SYMBOLS = {
    "SOXL": {"group": "3x 반도체", "buy_rsi": 25, "sell_rsi": None, "rebuy_rsi": None,
             "desc": "반도체 3배 레버리지", "buy_only": True},
    "TQQQ": {"group": "3x 나스닥", "buy_rsi": 25, "sell_rsi": None, "rebuy_rsi": None,
             "desc": "나스닥100 3배 레버리지", "buy_only": True},
    "SPXL": {"group": "3x S&P500", "buy_rsi": 30, "sell_rsi": None, "rebuy_rsi": None,
             "desc": "S&P500 3배 레버리지", "buy_only": True},
    "TNA":  {"group": "3x 소형주", "buy_rsi": 35, "sell_rsi": 70, "rebuy_rsi": 50,
             "desc": "러셀2000 3배 레버리지", "macro_filter": "copper",
             "bb_filter": True},
    "QLD":  {"group": "2x 나스닥", "buy_rsi": 25, "sell_rsi": None, "rebuy_rsi": None,
             "desc": "나스닥100 2배 레버리지", "buy_only": True},
    "UWM":  {"group": "2x 소형주", "buy_rsi": 25, "sell_rsi": 70, "rebuy_rsi": 50,
             "desc": "러셀2000 2배 레버리지", "macro_filter": "copper"},
    "QQQ":  {"group": "나스닥100", "buy_rsi": 25, "sell_rsi": None, "rebuy_rsi": None,
             "desc": "나스닥100 인덱스", "buy_only": True},

...
- **타임프레임**: 일봉 (daily)
- **분석 기간**: In-sample 전체, Rolling OOS 3yr train → 2yr test
...
| sell 필터 | 평균 Sharpe | 평균 수익률 | vs B&H 승률 |
|-----------|-----------|-----------|-------------|
...
> **주석**: 16,800 조합 집계 테이블. 개별 거래횟수/trades/yr는 종목·기간별 상이하여 행 단위 표기 불가.
...
> **주석**: Rolling OOS 106 윈도우 집계. 개별 거래횟수/trades/yr는 윈도우·종목별 상이하여 행 단위 표기 불가.

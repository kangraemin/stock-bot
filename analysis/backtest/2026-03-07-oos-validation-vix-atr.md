...
| 종목 | RSI baseline | ATR (train_best) | vs RSI | MaxDD | B/S | risk | atr_m | trades/yr | 판정 |
|------|-------------|-------------------|--------|-------|-----|------|-------|-----------|------|
| SOXL | +463.1% | +463.1% | +0.0% | -34.2% | 7B/6S | 1.0 | 1.0 | 2.2 | 동일 |
| TQQQ | +135.9% | +135.9% | +0.0% | -74.7% | 19B/18S | 1.0 | 1.0 | 6.2 | 동일 |
| SPXL | +294.9% | +294.9% | +0.0% | -70.5% | 12B/11S | 1.0 | 1.0 | 3.8 | 동일 |
| TNA | +75.5% | +75.5% | +0.0% | -84.8% | 14B/13S | 1.0 | 1.0 | 4.5 | 동일 |
| **QLD** | **+100.9%** | **+127.5%** | **+26.6%** | **-41.8%** | **10B/9S** | **0.05** | **1.5** | **3.2** | **PASS** |
| UWM | +160.7% | +65.4% | -95.3% | -45.4% | 13B/12S | 0.05 | 2.0 | 4.2 | FAIL |
| QQQ | +67.9% | +67.9% | +0.0% | -29.6% | 5B/4S | 1.0 | 1.0 | 1.5 | 동일 |
